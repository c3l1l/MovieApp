    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1981, 1, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Elijah", "Wood" },
                    { 2, new DateTime(1977, 1, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "Orlando", "Bloom" },
                    { 3, new DateTime(1958, 10, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Viggo", "Mortensen" },
                    { 4, new DateTime(1974, 11, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Leonardo", "DicCaprio" },
                    { 5, new DateTime(1974, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Christian", "Bale" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Lord Of The Rings 1- The Fellowship Of The Ring" },
                    { 2, 1, "Lord Of The Rings 2- The Two Towers" },
                    { 3, 1, "Lord Of The Rings 3- The Return Of The King" },
                    { 4, 2, "The Dark Knight" },
                    { 5, 2, "Inception" }
                });
